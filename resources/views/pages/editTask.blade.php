                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {{-- Image Task --}}
                            <div class="mb-3">
                                <label for="task_Img" class="form-label">Task Image</label>
                                <input type="file" class="form-control" name="image" id="task_Img{{$item->id}}"
...
<script>
    ...
    function removeImage() {
        const task_Img = document.getElementById('tas_kImg');
        const wrapImage = document.getElementById('wrapImage');
        const noImageText = document.getElementById('noImageText');
        const imageView = document.getElementById('imageView');
