                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-sm btn-primary" href="{{route('tasks.showPDF')}}" role="button">
                                Download PDF
                            </a>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped align-middle" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-bg-danger">
...
<script>
    ...
    if (successToast && {{ session()->has('success') ? 'true' : 'false' }}) {
